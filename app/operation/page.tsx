...
function OperationChatModal({ 
  ...
  const INITIAL_QUESTIONS: Record<string, string> = {
    "1": "【STEP 1/4】あなたのお店は、どのサービススタイルを採用しますか？（例: フルサービス、セルフサービス、セミセルフサービス）その理由も教えてください。",
    "2": "【STEP 1/4】お客様が入店から着席するまでのオペレーションの流れを具体的に定義してください。受付の有無、案内方法、メニューの渡し方などを考えてみましょう。",
    "3": "【STEP 1/4】ピーク時に、お客様を待たせず、かつサービスの質を維持するために、どのような仕組みやルールを導入しますか？",
    "4": "【STEP 1/4】お客様に提供する決済方法を決定してください。（選択肢：現金のみ、現金＋キャッシュレス、キャッシュレスオンリー）その理由も教えてください。",
    "5": "【STEP 2/4】メニューの提供スピードを確保するため、仕込みと調理の割合をどのように設定しますか？事前準備の重要性も考慮して考えてみましょう。",
    "6": "【STEP 2/4】ピーク時を含め、ホールとキッチンの理想的な社員とアルバイトの比率はどのように設定しますか？それぞれの役割も明確にしましょう。",
    "7": "【STEP 2/4】目指すコンセプトを実現するために、スタッフに求める接客スキルやマインドと、具体的な研修方法は何ですか？",
    "8": "【STEP 2/4】お客様の満足度を継続的に測定し、サービス改善に活かすための具体的な方法をどうしますか？（例：アンケート、レビューサイト、直接ヒアリングなど）",
    "9": "【STEP 3/4】料理の提供遅延やお客様からのクレームが発生した場合の対応手順を策定してください。迅速かつ丁寧な対応を心がけましょう。",
    "10": "【STEP 3/4】特に注力する衛生管理のルールや、清掃の頻度・担当者をどう設定しますか？食品衛生法の遵守も重要です。",
    "11": "【STEP 3/4】食材の発注や在庫管理は、手動ですか？それとも専用のシステムを導入しますか？効率的な管理方法を考えてみましょう。",
    "12": "【STEP 3/4】閉店後の締め作業や清算など、日々のルーティン作業に要する概算の時間と担当者を決定してください。効率化のポイントも考えてみましょう。",
  };
